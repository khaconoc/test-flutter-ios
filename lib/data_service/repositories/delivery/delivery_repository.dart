...
class DeliverRepository extends BaseRepository {

  Future<ResponseModel<String>> onHoanThanhTuyenPhat(
      {Map<String, dynamic> body}) async {
    var rs =
    await postApi(url: '/api/phat/PhatThuong/DeliveryUpdate', params: body);
  ...
  Future<ResponseModel<Map>> findOneBuuGuiOne(
      {Map<String, dynamic> body}) async {
    var rs =
    await postApi(url: '/api/phat/PhatThuong/ItemFindOne', params: body);
  ...
  Future<ResponseModel<Map>> findOneBuuGuiMore(
      {Map<String, dynamic> body}) async {
    var rs =
    await postApi(url: '/api/phat/PhatThuong/CustomerFindOne', params: body);
  ...
  Future<ResponseModel<String>> onPhatOne(Map params) async {
    var rs = await postApi(url: '/api/phat/PhatThuong/ItemUpdate', params: params);
    return ResponseModel(
  ...
  Future<ResponseModel<String>> onPhatMore(Map params) async {
    var rs = await postApi(url: '/api/phat/PhatThuong/ItemMultiUpdate', params: params);
    return ResponseModel(
      data: rs.data == null ? null : "success",
      error: rs.error,
    );
  ...
  Future<ResponseModel<Map>> getPagingItemInDelivery(Map params) async {
    var rs = await postApi(url: '/api/phat/PhatThuong/MailtripItemGetPaging', params: params);
    return ResponseModel(
