...
import 'receive_request_detail_controller.dart';

class ReceiveRequestDetailPage extends GetView<ReceiveRequestDetailController> {
  @override
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              FormComBoBoxNetwork(
                                ...
                                apiUrl:
                                    BaseRepository.getCustomerObjectCombobox,
                                params: {
                                  "allowReceiver": false,
                                  "allowSend": true,
                                  "customerCode": "--"
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: FormInputNumber(
                                      onChange: (value) {
                                        controller.itemNumberPostman.value =
                                            value;
                                        controller
                                            .itemNumberPostmanError.value = '';
                                      },
                                  ...
                                  Expanded(
                                    child: FormInputNumber(
                                      onChange: (value) {
                                        controller.itemNumberSecretPostman
                                            .value = value;
                                        controller.itemNumberSecretPostmanError
                                            .value = '';
                                      },
                                      value: controller
                                          .itemNumberSecretPostman.value,
                                      error: controller
                                          .itemNumberSecretPostmanError.value,
                              ...
                              IfWidget(
                                condition: controller.action.value == 'Assigne' || controller.action.value == 'Edit',
                                right: FormComBoBoxNetwork(
                                  label: 'Bưu cục bàn giao',
                                  value: controller.receiverPOSCode.value,
                                  error: controller.receiverPOSCodeError.value,
                                  onChange: (value) {
                                    controller.receiverPOSCode.value =
                                        value != null ? value['value'] : null;
                                    controller.receiverPOSCodeError.value = '';
                                  },
                                  // style: BccpAppTheme.textStyleWhite,
                                  hint: 'Chọn bưu cục',
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                  'Tìm thấy ${controller.count.value} bưu gửi'),
                              RichText(
                                  text: TextSpan(
                                      text: '+ Thêm bưu gửi',
