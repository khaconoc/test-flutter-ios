...
import '../receive_request_detail/receive_request_detail_controller.dart';
import 'package:get/get.dart';

class ReceivePackageCrudController extends GetxController {
  ReceiveRequestDetailController receiveRequestDetailController = Get.find();
  final ReceiveRepository receiveRepository;
  final CommonRepository commonRepository;

  ReceivePackageCrudController({this.receiveRepository, this.commonRepository});
  ...
  void khoiTao() async {
    ...
    var rs = await receiveRepository.findOneBuuGui(params);
    if(rs.ok()) {
  ...
  doPackage() async {
    ...
    var rs = await receiveRepository.capNhatBuuGui(params);
    if(rs.ok()) {
      /// reload list item page truoc
      receiveRequestDetailController.onLoadPagingItemList();
  ...
  removePackage() async {
    ...
    var rs = await receiveRepository.deleteBuuGui(params);
    if(rs.ok()) {
