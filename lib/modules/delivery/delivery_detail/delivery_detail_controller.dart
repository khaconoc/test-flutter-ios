...
class DeliveryDetailController extends GetxController {
  ...
  DeliveryDetailController({this.deliverRepository});
  ...
  Map<dynamic, dynamic> paramsDefault = {
    "mailtripID": Get.arguments['mailtripID'],
  };
            ...
            children: [
              Row(
                ...
                children: [
                  IconBottomSheet(
                    onPress: () async {
                      await Get.toNamed(Routes.DELIVERY_SEND_MORE,
                          arguments: data);
                      Get.back();
                    },
                    title: 'Phát nhiều',
  ...
  onHoanThanh() async {
    ...
    if (confirm) {
      ...
      if (rs.ok()) {
        deliveryController.listViewPagingKey.currentState.getData();
