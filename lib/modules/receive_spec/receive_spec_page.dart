...
class ReceiveSpecPage extends GetView<ReceiveSpecController> {
  @override
          ...
          children: [
            ...
            Expanded(
              child: Obx(() => AppListView(
                    ...
                    url: BaseRepository.getPagingTiepNhanDatBiet,
...
class ItemListReceiveAccepted extends StatelessWidget {
  ...
  final ReceiveSpecController c = Get.find();
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              Helpers.requestStatusToStringSpec(data['status']),
